...
public class Video {
    ...
    public void setSkipafter(Integer skipafter) { this.skipafter = skipafter; }
    ...
    public Integer getMaxbirate() { return maxbirate; }
    public void setMaxbirate(Integer maxbirate) { this.maxbirate = maxbirate; }

    public Integer getBoxingallowed() { return boxingallowed; }
    public void setBoxingallowed(Integer boxingallowed) { this.boxingallowed = boxingallowed; }

    public List<Integer> getPlaybackmethod() { return playbackmethod; }
    public void setPlaybackmethod(List<Integer> playbackmethod) { this.playbackmethod = playbackmethod; }

    public Integer getPlaybackend() { return playbackend; }
    public void setPlaybackend(Integer playbackend) { this.playbackend = playbackend; }
