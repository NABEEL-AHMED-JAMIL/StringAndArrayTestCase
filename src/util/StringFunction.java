...
public class StringFunction {
    ...
    public final static String front_back(String string , String string2){
        ...
        if(string.length()%2 == 0 && string2.length()%2 == 0){
            ...
            return string.substring(0, string.length()/2) + string2.substring(0,string2.length()/2) +
                    string.substring(string.length( )/2) + string2.substring(string2.length()/2);
        }else{
            // condition for first even and second odd
            if(string.length()%2 == 0 && string2.length()%2 == 1){
                // send back to the mian
                return string.substring(0, string.length()/2) + string2.substring(0,string2.length()/2+1) +
                        string.substring(string.length()/2) + string2.substring(string2.length()/2+1);
            }else{
                // this one work when both string are odd
                // send back to the main
                return string.substring(0, string.length()/2+1) + string2.substring(0,string2.length()/2+1) +
                        string.substring(string.length()/2+1) + string2.substring(string2.length()/2+1);
            }
        }
    }
